...
public class SearchTrain extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       out.println("<h1><center marginwidth='100px' marginheight='100px' ' align='right'><tr><th colspan ='3'><a href='view/searchTrain.html'>BACK</th></tr></center></h1>");
      
            out.println("<center><table border='1'margin-top='30px'>");
            out.println("<tr width='40px' height='40px'> <th colspan='4'> SHOW TRAINS </th><th colspan='3' height='40px' width='40px' ><a href='view/reservation.html' >Book Here</a></th></tr>");
            ...
            if(a.next()) {
               ...
               out.println("window.location=' view/searchTrain.html'");
               out.println("</script>");
            }
            out.println("</table>");
            out.println("</center>");
